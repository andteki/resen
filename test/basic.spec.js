...
const mockServer = require('./servers/basicServer')

describe('resen methods with basic auth', function () {
    ...
    it('get method with basic auth', async function () {
        const url = mockServer.getUrl()
        const result = await spawn('node', ['res.js', 'get',
            url,
            '--ignore-stdin',
            '--auth-type', 'basic', '--auth', 'admin:admin'
        ],
    ...
    it('post method with basic auth', async function () {
        const url = mockServer.getUrl()
    ...
    it('put method with basic auth', async function () {
        const url = mockServer.getUrl()
    ...
    it('patch method with basic auth', async function () {
        const url = mockServer.getUrl()
    ...
    it('delete method with basic auth', async function () {
        const url = mockServer.getUrl()
